...
For a quickstart guide, refer to the :doc:`GenAI API Guide <../../generative-ai-workflow>`.
...
The OpenVINO GenAI archive package includes the OpenVINO™ Runtime and :doc:`Tokenizers <../../generative-ai-workflow/ov-tokenizers>`.
