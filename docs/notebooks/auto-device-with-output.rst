...
.. parsed-literal::
    ...
    [23:12:18.4901]I[plugin.cpp:421][AUTO] device:CPU, config:LOG_LEVEL=LOG_INFO
    [23:12:18.4902]I[plugin.cpp:421][AUTO] device:CPU, config:PERFORMANCE_HINT=LATENCY
    [23:12:18.4902]I[plugin.cpp:421][AUTO] device:CPU, config:PERFORMANCE_HINT_NUM_REQUESTS=0
    [23:12:18.4902]I[plugin.cpp:421][AUTO] device:CPU, config:PERF_COUNT=NO
    [23:12:18.4902]I[plugin.cpp:426][AUTO] device:CPU, priority:0
    [23:12:18.4902]I[schedule.cpp:17][AUTO] scheduler starting
    [23:12:18.4902]I[auto_schedule.cpp:181][AUTO] select device:CPU
    [23:12:18.6198]I[auto_schedule.cpp:346][AUTO] Device: [CPU]: Compile model took 129.527441 ms
    [23:12:18.6199]I[auto_schedule.cpp:112][AUTO] device:CPU compiling model finished
    [23:12:18.6200]I[plugin.cpp:454][AUTO] underlying hardware does not support hardware context
...
.. parsed-literal::
    ...
    Deleted compiled_model[23:12:18.6257]I[schedule.cpp:308][AUTO] scheduler ending
...
.. parsed-literal::
    ...
    throughput:  183.29fps, latency:  31.36ms, time interval: 10.02s
    throughput:  181.08fps, latency:  32.44ms, time interval: 10.00s
    throughput:  181.87fps, latency:  32.21ms, time interval: 10.00s
    throughput:  180.71fps, latency:  32.45ms, time interval: 10.01s
    throughput:  179.05fps, latency:  32.81ms, time interval: 10.00s
    throughput:  182.16fps, latency:  32.21ms, time interval: 10.00s
    Done
...
.. parsed-literal::
    ...
    throughput:  141.23fps, latency:  6.58ms, time interval: 10.00s
    throughput:  143.10fps, latency:  6.58ms, time interval: 10.01s
    throughput:  143.14fps, latency:  6.58ms, time interval: 10.00s
    throughput:  143.19fps, latency:  6.57ms, time interval: 10.00s
    throughput:  135.76fps, latency:  6.97ms, time interval: 10.00s
    throughput:  143.34fps, latency:  6.58ms, time interval: 10.00s
    Done
